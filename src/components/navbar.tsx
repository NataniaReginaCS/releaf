...
const Navbar: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="flex justify-between items-center max-w-screen lg:px-23 mx-auto flex-wrap">
        <Link to="/">
        ...
        <div className="hidden md:flex space-x-6">
          <Dropdown
            ...
            onClick={() =>
              setActiveDropdown(
                activeDropdown === "Marketplace" ? null : "Marketplace"
              )
            }
          />
          <Dropdown
            ...
            onClick={() =>
              setActiveDropdown(
                activeDropdown === "Learn & Act" ? null : "Learn & Act"
              )
            }
          />
          <Dropdown
