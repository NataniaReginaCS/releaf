    ...
    <>
      ...
      <section className="relative w-full bg-white flex flex-col items-center text-center px-5 py-20 md:pt-[26vh]  ">
        ...
        <p className="text-[#142E38] text-lg md:text-2xl max-w-2xl z-10">
          Find inspiration, discussions, and exciting challenges to make
          preloved fashion a lifestyle.
        </p>
        <div className="mt-10 flex flex-col md:flex-row gap-5 z-10 text-md md:text-lg ">
          <Link to="/community">
            <button className="bg-white outline outline-[#D5EEC6] w-45 text-[#333333] px-6 py-2 rounded-full hover:bg-green-100">
              About Us
            </button>
          </Link>
          <Link to="/forum">
      ...
      <section className="pt-10 md:pt-70 bg-white" id="startLearning">
        <div className="grid grid-cols-1 md:grid-cols-2 md:ml-30 items-center text-center md:text-left">
          ...
          <p className="text-[#142E38] text-lg md:text-xl text-justify mt-5 mx-15 md:mx-0 md:mt-10">
            ...
            sustainable fashion. Here, you can share information about clothing
            donations, preloved fashion, and various community actions that
            support an eco-friendly lifestyle. Join to stay connected,
            contribute, and inspire positive change together!
          </p>
        </div>
      </section>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 mx-5 md:mx-20 py-10 items-center">
          <div className="flex flex-col text-center md:text-left  md:col-span-2 md:py-10">
            ...
            <p className="mt-5 text-lg text-justify z-10 md:py-4">
              ReLeaf Fashion is a community that believes in the power of
              sustainable fashion. We are committed to promoting eco-friendly
              practices and supporting a circular economy. Our mission is to
              inspire positive change in the fashion industry by encouraging
            ...
            <div className="flex flex-col gap-3 mt-5 z-10 w-full">
              <p className="text-md bg-[#D5EEC6] rounded-full px-5 py-2 z-10 min-w-0 text-center md:text-left">
                The hanger symbolizes fashion, while the leaves represent
                sustainability and eco-friendliness.
              </p>
              <p className="text-md bg-[#D5EEC6] rounded-full px-5 py-2 z-10 min-w-0 text-center md:text-left">
                Soft greens and earthy colors reflect nature, freshness, and
                eco-friendly business ethics.
              </p>
              <p className="text-md bg-[#D5EEC6] rounded-full px-5 py-2 z-10 min-w-0 text-center md:text-left">
                Minimalist and modern, reflecting transparency, professionalism
          ...
          <img
            src={iconAbout}
            alt="iconAbout"
            className="mt-10 md:mt-0 flex justify-center w-3/5 md:w-100 object-cover h-80 mx-auto md:ml-18 z-10"
          />
        </div>
      </section>
