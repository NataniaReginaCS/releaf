...
function HomeComponent() {
  return (
    <>
      <section className="h-lg md:h-screen flex flex-col-reverse md:flex-row items-center justify-between bg-white px-20 align-center mb-10 mt-20 md:mt-0 md:mb-0">
