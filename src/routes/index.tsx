            ...
            <section className="h-full md:h-screen flex flex-col-reverse md:flex-row items-center justify-between bg-white px-20 align-center pt-15 pb-5 md:pt-0 md:pb-0">
                ...
                <div className="w-full relative index-10">
                    ...
                    <p className="mt-4 text-lg md:text-xl text-gray-600">
                        ...
                        Sustainability, Creativity, And Purpose. Together, We
                        Extend The Life Of Every Piece, Transforming Waste Into
                        Wonder And Style Into A Movement.
                    </p>
                    <div className="mt-6 space-x-4 text-lg md:text-xl">
                        ...
                        <button
                            className="bg-[#FFD8BE] text-[#333333] px-4 py-2 mb-4 rounded-full w-2/3 md:w-48 hover:bg-green-100 cursor-pointer"
                            onClick={() =>
                                (window.location.href = "/learnAndAct")
                            }
                        >
                            Learn & Act
                        </button>
                ...
                <div className="w-screen md:w-4xl flex justify-center mt-4 mb-10 md:mt-0 relative index-10">
                    <img
                        src={maskot}
                        alt="ReLeaf Character"
                        className="w-3/5 md:w-128"
                    />
                </div>
            </section>
        </>
