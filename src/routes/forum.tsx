...
const diskusi = [
  ...
  },
  {
    ...
    message:
      "I am interested in donating clothes to ReLeaf Fashion. How does the process work? Do I just contact the available contact, then the team will come to pick up the donation? After the clothes are collected, how are they sorted and distributed to those in need? I want to make sure",
    date: "2 day ago",
    kategori: "Donation",
  },
  {
      ...
      <div className="min-h-full bg-white text-black">
        ...
        <div className="mx-7 mt-5 md:mt-20 md:mx-32 items-start">
          ...
          <p className="text-xl text-justify md:mt-10 md:w-3/5">
            Find a space to discuss, share experiences, and exchange inspiration
            about sustainable fashion. From preloved fashion, clothing
            donations, to tips on caring for clothes to make them last
            longer—join us and be part of the change!
          </p>
          <button
            type="submit"
            ...
            <div className="mb-4 grid grid-cols-2 gap-2 md:grid-cols-4">
              ...
              <div>
                <input
                  ...
                  className="mr-2"
                />
                <label htmlFor="mid">Donation</label>
              </div>
              <div>
                <input
                  type="radio"
                  ...
                  className="mr-2"
                />
                <label htmlFor="high">Community</label>
              </div>
              <div>
                <input
                  type="radio"
                  ...
                  className="mr-2"
                />
                <label htmlFor="high">Other</label>
              </div>
            </div>
            <button
              type="submit"
        ...
        <div className="flex flex-col items-start pt-10 md:pt-25 md:flex-row gap-6 p-6 md:mx-32">
          <div className="w-full md:h-auto md:w-3/9 bg-white p-4 rounded-lg border border-gray-300">
            ...
            <div className="mb-4">
              <h3 className="font-medium my-2">Sort by</h3>
              <div>
                <input type="radio" name="price" id="low" className="mr-2" />
                <label htmlFor="low">Latest</label>
              </div>
              <div>
                <input type="radio" name="price" id="mid" className="mr-2" />
                <label htmlFor="mid">The Oldest</label>
              </div>
            </div>
            <hr className="text-gray-300" />
            <div>
          ...
          <div className="w-full h-full flex flex-col">
            ...
            />
            <div
              className="w-full md:w-full grid grid-cols-1 md:grid-cols-1 gap-6 mb-13"
              id="more"
            >
              {diskusi
                .filter((p) =>
