			...
			<div className="min-h-full bg-white text-black">
				...
				<div className="mx-7 mt-5 md:mt-20 md:mx-32 items-start">
					...
					<p className="text-xl text-justify md:mt-10 md:w-3/5">
						Find a space to discuss, share experiences, and exchange inspiration about sustainable fashion. From preloved fashion, clothing donations, to tips on caring for clothes to make them last longer—join us and be part of the change!
					</p>
					<button
						type="submit"
					...
					<div className="w-full md:h-auto md:w-3/9 bg-white p-4 rounded-lg border border-gray-300">
						...
						<div>
							...
							<div className="flex flex-wrap gap-y-5 gap-x-5 pb-5">
								...
								<button className="p-2 bg-gray-100 rounded-full w-[30%]">Donation</button>
