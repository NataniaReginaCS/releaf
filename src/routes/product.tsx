...
function ProdukComponent() {
    ...
    return (
        <div className="bg-white mt-12 rounded-lg p-6 flex flex-col justify-center items-center md:flex-row gap-8">
            ...
            <div className="max-w-sm order-last">
                ...
                <p className="text-gray-600 mt-2 mb-4">
                    Kaos oblong - Bahan katun combed 30s yang nyaman dan adem.
                    Desain yang elegan dan kekinian. Tersedia dalam ukuran S-XL
                    dan berbagai pilihan warna.
                </p>
