      ...
      <section className="pt-20 md:pt-46 bg-white text-[#333333] ">
        ...
        <div className="flex flex-col md:justify-center mt-10 md:mx-30 mx-4">
          ...
          <p className="text-lg md:mx-20 mx-5 p-5 bg-[#E6E6E6] ">
            In 2021, clothing waste in Indonesia reached 2.3 million tons. This
            figure is equivalent to 12% of total household waste. Only 0.3
            million tons were recycled. Most of the clothing waste ends up in
            landfills without proper management. This fact highlights the huge
        ...
        <div className="flex flex-col justify-center mt-10 md:mx-30 mx-4">
          ...
          <p className="text-lg md:mx-20 mx-5 p-5 bg-[#E6E6E6]">
            Buying preloved helps reduce new production and carbon emissions,
            extends the life cycle of clothing, reduces textile waste ending up
            in landfill, and supports a more sustainable, circular economy.
          </p>
        </div>
        <div className="flex flex-col justify-center mt-10 md:mx-30 mx-4">
          <h2 className="text-xl font-bold bg-[#D2D2D2] p-3 md:w-[50%]">
          ...
          <p className="text-lg md:mx-20 mx-5 p-5 bg-[#E6E6E6]">
            Extending the life cycle of clothing helps reduce textile waste,
            reduces resource use and reduces carbon emissions from new
            production. By supporting a circular economy, this creates more
            sustainable and environmentally friendly consumption patterns.
          </p>
        </div>
      </section>
      ...
      <section className="bg-white text-[#333333]">
        <div className="flex flex-col md:flex-row justify-center pt-20 md:pt-40 gap-20 md:ml-20">
          ...
          <div className="flex flex-col">
            ...
            <ul className="list-image-[url(${check})] list-outside list-disc mt-10 md:ml-10 mx-20 max-sm:text-justify text-left text-lg">
              <li className="pl-3 ml:pl-0 mb-5 align-top">
                Using cold water helps maintain the color and fibers of the
                fabric so that they are not easily damaged.
              </li>
              <li className="pl-3 ml:pl-0 mb-5 align-top">
                Choose an environmentally friendly detergent that is free of
                harsh ingredients to keep your clothes durable.
              </li>
              <li className="pl-3 ml:pl-0 mb-5 align-top">
                Dry clothes naturally to prevent shrinkage and maintain fabric
                elasticity.
              </li>
              <li className="pl-3 ml:pl-0 mb-5 align-top">
                Fold delicate fabrics and hang wrinkle-prone items to maintain
                their shape.
              </li>
              <li className="pl-3 ml:pl-0 mb-5 align-top">
                Sew up loose buttons or small tears so that the clothes can be
                used longer and don't end up as quickly as waste.
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="pt-20 md:pt-40 px-5 md:px-0 bg-white text-[#333333] pb-20 md:pb-30 ">
        ...
        <div className="grid grid-flow-col grid-cols-3 max-sm:grid-rows-3 gap-20 text-center mt-0 md:mt-30 mx-10 md:mx-40 max-sm:h-400 max-sm:pt-10">
          <div className="flex flex-col justify-center p-3 md:p-5 rounded-3xl shadow-xl bg-white z-10 max-sm:w-70 ">
            ...
            <p className="pt-5">
              Swapping clothes reduces textile waste ending up in landfills and
              slows environmental pollution from producing new clothes.
            </p>
          </div>
          <div className="flex flex-col justify-center p-3 md:p-5 rounded-3xl shadow-xl bg-white z-10 max-sm:w-70">
            ...
            <p className="pt-5">
              Swapping clothes helps save water and energy used in the
              production of new clothes and reduces carbon emissions from the
          ...
          <div className="flex flex-col justify-center p-3 md:p-5 rounded-3xl shadow-xl bg-white z-10 max-sm:w-70">
            ...
            <p className="pt-5">
              Swapping clothes extends the life cycle of clothing by reusing
              them, while encouraging more sustainable and responsible
