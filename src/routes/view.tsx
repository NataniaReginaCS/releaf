    ...
    return (
        <>
            <section className="h-screen bg-white">
                <h1 className="text-[#142E38] absolute z-10 font-bold text-6xl text-center w-screen top-[40%] text-center">
                    Join the ReLeaf Fashion Community
                </h1>
                <p className="text-[#142E38] absolute z-10 text-xl text-center w-screen top-[50%] text-center ">
                    Connect, share and grow together in a community that cares
                    about{" "}
                </p>
                <p className="text-[#142E38] absolute z-10 text-xl text-center w-screen top-[53%] text-center ">
                    sustainable fashion. Find inspiration, discussions and
                    exciting challenges to{" "}
                </p>
                <p className="text-[#142E38] absolute z-10 text-xl text-center w-screen top-[56%] text-center ">
                ...
                <img
                    ...
                    className="absolute w-screen z-1 opacity-20 h-[100%]"
                />
                <div className="w-screen bg-[#ACACAC] opacity-100 h-[98%]"></div>
            </section>
        </>
    );
}
